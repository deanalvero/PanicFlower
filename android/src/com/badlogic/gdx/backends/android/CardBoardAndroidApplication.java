...
public class CardBoardAndroidApplication extends CardboardActivity implements AndroidApplicationBase {
    ...
    *
    * @param listener the {@link ApplicationListener} implementing the program logic
    * @param config the {@link AndroidApplicationConfiguration}, defining various layout_settings of the application (use accelerometer,
    *           etc.). */
   ...
   @Override
    public void onCardboardTrigger() {
       if (!(listener instanceof CardBoardApplicationListener)) {
           throw new RuntimeException("should implement com.badlogic.gdx.backends.android.CardBoardApplicationListener");
        }
